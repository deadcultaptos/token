...
function Hero() {
  return (
    <div className='text-gray-200 text-center w-full mx-auto h-screen mt-96px max-w-[800px] flex flex-col justify-center space-y-2'>
            <strong className='text-maincolor text-2xl uppercase font-bold p-2'>Football World Cup TOKEN</strong>
          ...
          <div className='space-x-5 pt-10 font-bold'>
            <Link href=""><button className='border text-bold py-3 px-5 rounded-md bg-maincolor border-maincolor text-gray-900'>BUY $FWCI</button></Link>
            <Link href=""><button className='border text-bold py-3 px-5 rounded-md text-maincolor hover:text-white'>$FWCI CHART</button></Link>
          </div>
    </div>
  )
}
